 ...
 */
int status_set_hp(struct block_list *bl, unsigned int hp, enum status_heal_flag flag)
{
 ...
 */
int status_set_sp(struct block_list *bl, unsigned int sp, enum status_heal_flag flag)
{
	struct status_data *st;
 ...
 */
int status_heal(struct block_list *bl, int64 in_hp, int64 in_sp, enum status_heal_flag flag)
{
	struct status_data *st;
	struct status_change *sc;
	int hp,sp;
